...
def update_password(user_id: str, new_hashed_password: str) -> Optional[dict]:
    """Update the user's hashed password. Returns the updated user or None."""
    user = get_user_by_id(user_id)
    if user is None:
        return None
